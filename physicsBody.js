...
class PhysicsBody {
  ...
  calculateConnectedBodyRadius(index) {
    ...
    const minimumRadiusPercentage = minimumRadiusForMass / this.radius;
  ...
  attractBody(body, t = 1 / 60) {
    ...
    addGravityAcceleration(body, accelerationMagnitude);
...
function addGravityAcceleration(body, accelerationMagnitude) {
  if (typeof body.addGravityAcceleration === "function") {
    body.addGravityAcceleration(accelerationMagnitude);
    return;
  }
